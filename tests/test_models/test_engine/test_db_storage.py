...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new(self):
        """ correctly added new object to database """
        new = User(
    ...
    def test_delete(self):
        """ correctly deleted objected from database """
        new = User(
            email='john2020@gmail.com',
            password='password',
            first_name='John',
    ...
    def test_reload(self):
        """ reloading of the database session """
        dbc = MySQLdb.connect(
            host=os.getenv('HBNB_MYSQL_HOST'),
            port=3306,
            user=os.getenv('HBNB_MYSQL_USER'),
