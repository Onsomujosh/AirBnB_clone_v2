...
class test_basemodel(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        """initialises the test class of basemodel """
    ...
    def test_init(self):
        """model class initialization test"""
        self.assertIsInstance(self.valie(), BaseModel)
        if self.value is not BaseModel:
            self.assertNotIsInstance(self.value(), Base)

    def test_default(self):
        """basemodel default testing """
        i = self.value()
        self.assertEqual(type(i), self.value)

    def test_kwargs(self):
        """basemodel with kwargs testing """
        i = self.value()
        copy = i.to_dict()
        new = BaseModel(**copy)
